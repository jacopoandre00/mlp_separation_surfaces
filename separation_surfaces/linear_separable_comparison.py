...
from linear_separable import create_linear_separable
...
if __name__ == "__main__":
    ...
    lr_loss, lr_accuracy=lr_model.evaluate(X_test, y_test)
    plot_decision_boundary(X, y, lr_model, f'Logistic Regression (Accuracy: {lr_accuracy:.2f}, Loss: {lr_loss:.4f})')
